...
class ChatInput extends React.Component {
  ...
  render() {
    ...
    var style = 'background-image:url('+imgURL+'); background-size:cover;background-position:center center';
    return (
          ...
          <form className="container" onSubmit={ onSubmit }>
            <div className="row">
              ...
              <div className="input-field col s2">
                <button type="submit" className="send-btn waves-effect waves-light btn-floating btn-large">
                  <img src={ imgURL } className="button-image"/>
